...
@-webkit-keyframes spinoff {
 ...
 100% { -webkit-transform:rotate(-360deg); }
    ...
    .container {margin-top: 10px; overflow: hidden; text-align: center; font-family:sans-serif;background-color: white;color: #46b8da;}
